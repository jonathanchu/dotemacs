...
** Use different search methods depending on number of lines
   Source - https://github.com/abo-abo/swiper/issues/416#issuecomment-207770727

   #+BEGIN_SRC emacs-lisp :tangle yes
     (defun ora-swiper ()
       "Uses swiper to search if buffer size is not large."
       (interactive)
