...
main goal of this is to help improve documentation of settings.

This file is tangled using =org-babel-load-file= and it generates an
=emacs-init.el= from the =emacs-lisp= source blocks.
