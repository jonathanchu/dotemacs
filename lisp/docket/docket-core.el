;;; docket-core.el --- Core data layer for docket -*- lexical-binding: t -*-
...
;; Core data layer for docket: customization, task struct, org parsing,
;; cache, task queries, and mutations.  Other docket modules depend on
;; this file; this file depends on nothing within docket.
