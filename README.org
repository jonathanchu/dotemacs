...
#+CAPTION: doom-modeline, Catppuccin Frappe color theme, JetBrains Mono font
#+NAME: Screenshot
...
** Nerd Fonts
   ...
   =doom-modeline= and =nerd-icons= require a Nerd Font to render
   icons correctly. Install the bundled Symbols Nerd Font Mono from
   within Emacs:
   ...
   On macOS this downloads the font to =~/Library/Fonts/=. Restart
   Emacs afterwards.
