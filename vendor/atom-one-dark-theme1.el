...
(custom-theme-set-faces
 ...
 '(default ((t (:foreground "#abb2bf" :background "#31343F" :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :inherit nil))))
 ...
 '(font-lock-string-face ((t (:foreground "#98c379"))))    ;; done, green
